...
public class FavoriteApiController implements FavoriteApi {
    ...
    @Override
    public ResponseEntity<Void> deleteFavoriteBooks(@Valid SendLikeInfo sendLikeInfo) {
        System.out.print(sendLikeInfo.toString());
        return ResponseEntity.ok().build();
    }

    @Override
    public ResponseEntity<Void> favoriteBooks(@Valid SendLikeInfo sendLikeInfo) {
        System.out.print(sendLikeInfo.toString());
        return ResponseEntity.ok().build();
    }
